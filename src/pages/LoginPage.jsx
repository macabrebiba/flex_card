        ...
        <form className="max-w-lg rounded-lg mx-auto">
          <div className="flex flex-col gap-4 p-4 md:p-8">
            ...
            >
              ...
              <button
                className="flex justify-center items-center bg-white hover:bg-gray-100 active:bg-gray-200 border border-gray-300 focus-visible:ring ring-gray-300 text-gray-800 text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 gap-2 px-8 py-3 ml-12 "
                style={{
                  width: "120" + "px",
                  height: "45" + "px",
                  borderRadius: "5" + "px",
